...
#define LOCTEXT_NAMESPACE "UwajimayaEditor"
...
void FSoEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(BuildAll, "Build All", "Uwajimaya Build all Version. Builds all levels (precomputes lighting data and visibility data, generates navigation networks and updates brush models.)", EUserInterfaceActionType::Button, FInputChord());
