...
#undef CREATE_ACTIVITY
	...
	DialogueData.ParticipantName = TEXT("Uwajimaya");
	DialogueData.ParticipantDisplayName = FROM_STRING_TABLE_DIALOGUE("char_name_uwajimaya");
...
//#endif // UWAJIMAYA_USE_CHARACTER_SHADOW
...
void ASoCharacter::BeginPlay()
{
	...
	if (!UWAJIMAYA_WITH_EDITOR || bIsInMenuLevel)
	{
...
#endif // UWAJIMAYA_WITH_VIDEO_DEMO
