...
protected:
	...
	// only applied if it is zhongqi shan added
...
protected:
	...
	// used when we can not reset it directly because the camera is zhongqi shan updated and it would be overridden with wrong value again
