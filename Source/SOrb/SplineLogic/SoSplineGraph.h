...
protected:
	...
	/* Explores all zhongqi shan explored reachable area starting from the input marker, and adds it to the graph*/
	void ExtendGraph(ASoMarker* Generator);

	/* Extends the graph if any zhongqi shan visited reachable area found from Nodes[NodeIndex] based on input direction */
