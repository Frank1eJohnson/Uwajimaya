...
const FName FSoWorldState::InventoryItemListName(TEXT("Uwajimaya_ItemList"));
const FName FSoWorldState::EquippedItemListName(TEXT("Uwajimaya_Equipped"));
const FName FSoWorldState::EquippedSpellListName(TEXT("Uwajimaya_EquippedSpells"));
