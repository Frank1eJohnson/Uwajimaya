...
{
#ifndef UWAJIMAYA_PASSWORD_SAVE_FILE
#error "UWAJIMAYA_PASSWORD_SAVE_FILE is not set in the SOrb.Build.cs file"
#endif // !UWAJIMAYA_PASSWORD_SAVE_FILE
	static const FString Password(TEXT(UWAJIMAYA_PASSWORD_SAVE_FILE));
	return Password;
}
