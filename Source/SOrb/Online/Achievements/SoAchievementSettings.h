...
UCLASS(Config = SoAchievementSettings, DefaultConfig, meta = (DisplayName = "Uwajimaya Achievements"))
...
public:
	...
	FName GetSectionName() const override { return "Uwajimaya Achievements"; };
