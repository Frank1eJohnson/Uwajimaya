...
UCLASS(Config = SoGameSingleton, DefaultConfig, Blueprintable, BlueprintType, meta = (DisplayName = "Uwajimaya Singleton"))
...
public:
	...
	FName GetSectionName() const override { return TEXT("Uwajimaya Singleton"); };
