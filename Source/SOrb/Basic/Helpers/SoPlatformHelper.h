...
public:
	...
	// Gets the build version of this game (Uwajimaya) duh.
	...
	UFUNCTION(BlueprintPure, Category = ">Build")
	static bool IsDemo() { return UWAJIMAYA_DEMO; }
	...
	UFUNCTION(BlueprintPure, Category = ">Build")
	static bool IsWithSteam() { return UWAJIMAYA_WITH_STEAM; }
	...
	{
		return bDemo ? UWAJIMAYA_STEAM_DEMO_APP_ID : UWAJIMAYA_STEAM_APP_ID;
	}
	...
	{
		return bDemo ? UWAJIMAYA_DISCORD_DEMO_CLIENT_ID : UWAJIMAYA_DISCORD_CLIENT_ID;
	}
	...
	static bool UseAsusAuraSDK() { return PLATFORM_WINDOWS && UWAJIMAYA_USE_ASUS_AURA_SDK; }
	...
	{
		return PLATFORM_XBOXONE || PLATFORM_SWITCH || PLATFORM_PS4 || UWAJIMAYA_CONSOLE_TEST;
	}

	UFUNCTION(BlueprintPure, Category = ">Platform")
	static bool CanHaveKeyboard()
	{
		if (UWAJIMAYA_NO_KEYBOARD_TEST)
			return false;
