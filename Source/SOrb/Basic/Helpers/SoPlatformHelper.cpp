...
const FString& USoPlatformHelper::ToStringCompileFlags()
{
	static const FString Output = FString::Printf(
		TEXT("Compiled flags:\n")
		TEXT("\tUWAJIMAYA_NON_EDITOR_TEST = %d, UWAJIMAYA_NON_EDITOR_COLLECT_ANALYTICS_TEST = %d\n")
		TEXT("\tWITH_EDITOR = %d, UWAJIMAYA_WITH_EDITOR = %d\n")

		TEXT("\tUWAJIMAYA_WITH_ANALYTICS = %d, UWAJIMAYA_WITH_GAMEANALYTICS = %d, UWAJIMAYA_COLLECT_ANALYTICS = %d\n")
		TEXT("\tUWAJIMAYA_WITH_ONLINE = %d, UWAJIMAYA_DEMO = %d\n")
		TEXT("\tUWAJIMAYA_WITH_STEAM = %d, UWAJIMAYA_STEAM_APP_ID = %d, UWAJIMAYA_RELAUNCH_IN_STEAM = %d\n")
		TEXT("\tUWAJIMAYA_WITH_DISCORD = %d, UWAJIMAYA_DISCORD_CLIENT_ID = %lld\n")
		TEXT("\tUWAJIMAYA_WITH_SDL2 = %d, UWAJIMAYA_USE_ASUS_AURA_SDK = %d\n")

		TEXT("\tUWAJIMAYA_USE_CHARACTER_SHADOW = %d, UWAJIMAYA_USE_UNREAL_SAVE_SYSTEM = %d, UWAJIMAYA_USE_ARROW_PRESET_AS_DEFAULT = %d, UWAJIMAYA_ALLOW_CONSOLE_CHEATS_DEFAULT = %d\n")
		TEXT("\tUWAJIMAYA_WITH_VIDEO_DEMO = %d, UWAJIMAYA_WITH_VIDEO_INTRO= = %d\n")
		...
		UWAJIMAYA_NON_EDITOR_TEST, UWAJIMAYA_NON_EDITOR_COLLECT_ANALYTICS_TEST,
		WITH_EDITOR, UWAJIMAYA_WITH_EDITOR,

		UWAJIMAYA_WITH_ANALYTICS, UWAJIMAYA_WITH_GAMEANALYTICS, UWAJIMAYA_COLLECT_ANALYTICS,
		UWAJIMAYA_WITH_ONLINE, UWAJIMAYA_DEMO,
		UWAJIMAYA_WITH_STEAM, GetSteamAppID(UWAJIMAYA_DEMO), UWAJIMAYA_RELAUNCH_IN_STEAM,
		UWAJIMAYA_WITH_DISCORD, GetDiscordClientID(UWAJIMAYA_DEMO),
		UWAJIMAYA_WITH_SDL2, UWAJIMAYA_USE_ASUS_AURA_SDK,

		UWAJIMAYA_USE_CHARACTER_SHADOW, UWAJIMAYA_USE_UNREAL_SAVE_SYSTEM, UWAJIMAYA_USE_ARROW_PRESET_AS_DEFAULT, UWAJIMAYA_ALLOW_CONSOLE_CHEATS_DEFAULT,
		UWAJIMAYA_WITH_VIDEO_DEMO, UWAJIMAYA_WITH_VIDEO_INTRO,
...
{
#ifndef UWAJIMAYA_BUILD_VERSION
#error "UWAJIMAYA_BUILD_VERSION is not set in the SOrb.Build.cs file"
#endif // !UWAJIMAYA_BUILD_VERSION

	static const FString BuildVersion(TEXT(UWAJIMAYA_BUILD_VERSION));
#if WITH_EDITOR
...
{
#ifndef UWAJIMAYA_BUILD_BRANCH
#error "UWAJIMAYA_BUILD_BRANCH is not set in the SOrb.Build.cs file"
#endif // !UWAJIMAYA_BUILD_BRANCH

	static const FString BuildBranch(TEXT(UWAJIMAYA_BUILD_BRANCH));
	return BuildBranch;
}
...
{
#ifndef UWAJIMAYA_BUILD_COMMIT
#error "UWAJIMAYA_BUILD_COMMIT is not set in the SOrb.Build.cs file"
#endif // !UWAJIMAYA_BUILD_COMMIT

	static const FString BuildCommit(TEXT(UWAJIMAYA_BUILD_COMMIT));
	return BuildCommit;
}
...
{
#if UWAJIMAYA_WITH_STEAM
	return UNYSteamHelper::Initialize(GetSteamAppID(IsDemo()), UWAJIMAYA_RELAUNCH_IN_STEAM);
#else
	return false;
#endif
}
...
bool USoPlatformHelper::IsSteamBuildPirated()
{
	...
	// Try Hash
	static const FString SteamLibraryWindowsAPI64Sha1Sum(TEXT(UWAJIMAYA_STEAM_LIBRARY_WINDOWS_API64_SHA1_SUM));
