...
public class UwajimayaTarget : TargetRules
{
	// See https://docs.unrealengine.com/en-us/Programming/UnrealBuildSystem/TargetFiles for documentation
	public UwajimayaTarget(TargetInfo Target) : base(Target)
	{
		Console.WriteLine("Using Uwajimaya.Target.cs");
	...
	public void Init(TargetInfo Target)
	{
		...
		bUsesSteam = UWAJIMAYA_WITH_STEAM;
		//if (bUsesSteam)
		//{
